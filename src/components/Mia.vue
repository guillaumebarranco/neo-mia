<template>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="mia" x="0" y="0" viewBox="0 0 600 800" enable-background="new 0 0 600 800" xml:space="preserve">
...
<style scoped>
    ...
    #mouth {
        transform-origin: center center;
        &.anim {
            animation: mouth 1s ease-in-out 0s infinite;
        }
    }
    ...
    @keyframes mouth {
        ...
        20%, 80% { transform: scale(0,5,0); }
        40%, 95% { transform: scale(1, 4) }
    }
