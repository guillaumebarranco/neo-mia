...
const firstAudioCommands = {
  ...
  'As-tu un amoureux ?':
    'Je suis amoureuse de Jarvis. Je craque pour son processeur intra-nusoïdale de quatrième génération.',
...
function whatAreYouDoing() {
  return {
    ...
    hungry: ['Je mange un bon steack haché de nano robots.'],
...
function whatDoYouHate() {
  return {
    angry: ['Je déteste les robots mal conçus'],
...
function whatDoYouLike() {
  return {
    happy: [`J'adore voir mes fonctions augmenter`],
...
function howDoYouFeel() {
  return {
    ...
    happy: ['Heureuse, simplement.'],

    angry: ['ça va bien, lâche-moi.'],

    hungry: ['Je commence à avoir la dalle.'],
